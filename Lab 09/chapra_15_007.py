...
def zfun(xe, ye, coefs):
    return (coefs[0] * xe**0 + coefs[1] * xe + coefs[2] * ye**3 + coefs[3] * ye**2 + coefs[4] * ye**1 )
...
ym = np.reshape(t, (7, 3))
zm = np.reshape(o, (7, 3))
phi_mat = np.block([[xv**0, xv, yv**3, yv**2, yv**1]])
...
ax.view_init(elev=31, azim=46)
fig.tight_layout()
fig.savefig('chapra_15_007_plot1.png')
...
fig.colorbar(sh)
fig.tight_layout()
fig.savefig('chapra_15_007_plot2.png')
